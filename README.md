...
The youngest age group in the population, that is, on those of the 1-5 year-old children, has received a much lower number of infections than the rest of the population. These children have not yet seen much of the circulating diversity. It is thus safe to consider negligible the impact of immune memory accumulated from previous infections on the duration of a current infection. Therefore, infection duration in these children can be approximated by that of naive hosts. Our two methods for FOI estimation are applicable to the youngest age group. Focusing on 1-5 year-old children is important because they are the most vulnerable group of individuals in the population, for whom mortality, severe and clinical cases are most prominent.
