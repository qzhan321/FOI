...
The two methods rely on the duration of infection for FOI estimation. But duration infection information is highly heterogeneous across various factors including age and transmission settings, and are often unavailable. Estimates of the duration of infection of naive hosts are available from a historical medical intervention in which patients with neurosyphilis were infected with malaria as a therapy. Between 1940 and 1963, 318 patients with syphilis were intentionally infected with a single strain of *P. falciparum* ([Collins et al., Am J Trop Med Hyg, 1999.](10.4269/tropmed.1999.61-036) and [Maire et al., Am J Trop Med Hyg, 2006.](10.4269/ajtmh.2006.75.19)). Data on fever and the number of malaria parasites in the blood were recorded. Because those patients had never been infected with *P. falciparum* malaria prior to the treatment, the documented infection duration is representative of naive infections.

The youngest age group in any population, for example, on those of the 1-5 year-old children, in general has received a much lower number of infections than the rest of the population. These children have not yet seen much of the circulating diversity. It is thus safe to consider negligible the impact of immune memory accumulated from previous infections on the duration of a current infection. Therefore, infection duration in these children can be approximated by that of naive hosts. Our two methods for FOI estimation are applicable to the youngest age group. Focusing on young children is important because they are the most vulnerable group of individuals in the population, for whom mortality, severe and clinical cases are most prominent.
...
|  `d`  | The full path to the file where the mean and variance of infection duration are stored if both are available for your empirical datasets. For example, "meanAndvarDurInfo.RData". If it's NULL, the default mean and variance information [section](#Applicability-of-The-Two-Methods) are used. |
